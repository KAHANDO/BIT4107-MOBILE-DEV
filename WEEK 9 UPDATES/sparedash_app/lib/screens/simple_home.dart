...
import 'parts_near_me_screen.dart';
...
class _SimpleHomeScreenState extends State<SimpleHomeScreen> {
  ...
  final List<String> _categories = [
    'Engine', 'Brakes', 'Electric', 'Body', 'Suspension', 'Transmission'
  ];
  ...
  Future<void> _loadParts(String category) async {
    ...
    final parts = await DatabaseHelper.instance.getPartsByCategory(category);
    setState(() {
      _currentParts = parts;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Quick actions — 4 buttons including camera
            Row(
              children: [
                Expanded(child: _buildQuickAction(context,
                ...
                const SizedBox(width: 8),
                Expanded(child: _buildQuickAction(context,
                    icon: Icons.location_on, label: 'Near Me',
                    color: const Color(0xFF059669),
                    onTap: () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const PartsNearMeScreen())))),
                const SizedBox(width: 8),
                Expanded(child: _buildQuickAction(context,
                    icon: Icons.camera_alt, label: 'My Photo',
                    color: const Color(0xFFf59e0b),
                    onTap: () => Navigator.push(context,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Find parts for your specific car model',
                              style: TextStyle(color: Colors.white70, fontSize: 12)),
                        ],
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text('Parts Near Me',
                              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
                          Text('Find sellers near your GPS location',
                              style: TextStyle(color: Colors.white70, fontSize: 12)),
                        ],
                      ),
                    ),
              ...
              child: Container(
                ...
                child: const Row(
                  children: [
                    ...
                    SizedBox(width: 12),
                    Expanded(child: Text('Search parts...', style: TextStyle(color: Colors.grey))),
            ...
            Container(
              ...
              child: const Row(
                children: [
                  Icon(Icons.touch_app, color: Color(0xFF2563EB), size: 16),
                  SizedBox(width: 8),
                  Text('Long press any part for quick details',
            ...
            if (_isLoadingParts)
              ...
              ..._currentParts.map((part) => Padding(
                ...
                child: _buildPartCard(
                  ...
                  priceValue: (part['price_value'] as num).toDouble(),
  ...
  Widget _buildPartCard(BuildContext context,
      {required String name, required String price,
        required double priceValue, required bool inStock,
        required String seller, required String location, required double rating}) {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(price, style: const TextStyle(color: Color(0xFFf59e0b), fontWeight: FontWeight.bold, fontSize: 15)),
                        const SizedBox(height: 2),
                        Row(children: [
                  ...
                  if (quantity > 0)
                    Container(
                      ...
                      child: Row(
                        children: [
                          IconButton(
                            onPressed: () => cart.updateQuantity(name, quantity - 1),
                    ...
                    Container(
                      ...
                      child: IconButton(
                        onPressed: inStock
                            ? () {
                          cart.addToCart(
                            id: name, name: name, price: price,
                            priceValue: priceValue, inStock: inStock,
                          );
