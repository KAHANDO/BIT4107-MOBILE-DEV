            ...
            Row(
              children: [
                Expanded(child: _buildQuickAction(context,
                    icon: Icons.receipt_long, label: 'My Orders', color: const Color(0xFF2563EB),
                    onTap: () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => OrderTrackingScreen())))),
                const SizedBox(width: 12),
                Expanded(child: _buildQuickAction(context,
                    icon: Icons.local_shipping, label: 'Shipping', color: const Color(0xFF1E40AF),
                    onTap: () => Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const ShippingScreen())))),
                const SizedBox(width: 12),
                Expanded(child: _buildQuickAction(context,
                    icon: Icons.person, label: 'Profile', color: const Color(0xFFf59e0b),
                    onTap: () => Navigator.push(context,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(price,
                            style: const TextStyle(
                                color: Color(0xFFf59e0b), fontWeight: FontWeight.bold, fontSize: 15)),
                        const SizedBox(height: 2),
                        Row(children: [
