...
class DatabaseProvider extends ChangeNotifier {
  ...
  Future<bool> placeOrder({required String partName, required int quantity, required double totalPrice}) async {
    if (_currentEmail == null) return false;
    final id = await _db.placeOrder(userEmail: _currentEmail!, partName: partName, quantity: quantity, totalPrice: totalPrice);
    notifyListeners();
    return id > 0;
  }
