...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Place an order from the cart to track it here',
  ...
  Widget _buildOrderCard(Map<String, dynamic> order) {
    ...
    final seller =
        order['seller'] as String? ?? 'SpareDash Seller';
    final location =
        order['location'] as String? ?? 'Nairobi, Kenya';
                  ...
                  children: [
                    Expanded(
                      child: _buildStatusChip(
                          orderId, 'processing', status),
                    ),
                    const SizedBox(width: 6),
                    Expanded(
                      child: _buildStatusChip(
                          orderId, 'shipped', status),
                    ),
                    const SizedBox(width: 6),
                    Expanded(
                      child: _buildStatusChip(
                          orderId, 'delivered', status),
                    ),
                    const SizedBox(width: 6),
                    IconButton(
            ...
            children: [
              Column(
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    steps[index][0].toUpperCase() +
                        steps[index].substring(1),
                    style: TextStyle(
                      fontSize: 9,
                      color: isActive
                          ? _statusColor(steps[index])
  ...
  Widget _buildStatusChip(
      int orderId, String status, String currentStatus) {
