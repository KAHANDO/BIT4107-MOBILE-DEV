...
class CartScreen extends StatelessWidget {
  ...
  Widget _buildTotalSection(BuildContext context, CartProvider cart) {
    return Container(
      ...
      child: Column(
        children: [
          _buildTotalRow(
              'Subtotal', 'KES ${cart.subtotal.toStringAsFixed(0)}'),
          const SizedBox(height: 8),
          _buildTotalRow(
              'Delivery Fee', 'KES ${cart.deliveryFee.toStringAsFixed(0)}'),
  ...
  Future<void> _showCheckoutDialog(
    ...
    // Save each cart item as a real order in SQLite
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(
                  color: Color(0xFFf59e0b), fontSize: 16),
            ),
            const SizedBox(height: 8),
  ...
  Widget _buildBottomNavBar(BuildContext context, int currentIndex) {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(
            icon: Icon(Icons.local_shipping), label: 'Ship'),
        BottomNavigationBarItem(
