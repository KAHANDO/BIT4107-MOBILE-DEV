    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Results area — using Material instead of Container
          // to fix ListTile ink splash visibility warning
          Expanded(
            child: Material(
              color: Colors.white,
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'Try: Toyota, Nissan, Subaru, Isuzu',
              style: TextStyle(
              ...
              return ListTile(
                ...
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                          'Finding parts for ${_results[index]}...'),
                      backgroundColor: const Color(0xFF2563EB),
                    ),
                  );
                },
